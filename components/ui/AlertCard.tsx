...
export function AlertCard({ level, weather, tideLevel, onClick }: AlertCardProps) {
  ...
  return (
    <motion.button
      ...
      className="pointer-events-auto absolute bottom-40 left-4 right-4 z-[1000] rounded-2xl bg-white px-5 py-4 text-left shadow-xl md:bottom-4 md:left-1/2 md:right-auto md:w-[420px] md:-translate-x-1/2"
    >
