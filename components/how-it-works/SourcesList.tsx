const SOURCES = [
  ...
  { name: "WeatherAPI.com — vento, umidade, pressão e chuva na última hora", url: "https://www.weatherapi.com" },
  { name: "Open-Meteo — clima em tempo real (fallback)", url: "https://open-meteo.com" },
