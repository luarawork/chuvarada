...
export const METRIC_INFO = {
  ...
  forecast: {
    ...
    description:
      "Condição atual e previsão hora a hora pras próximas 12 horas, com dado horário real (não interpolado). A porcentagem é a chance de chover naquele horário. O selo colorido embaixo do horário (🟢🟡🔴) é uma estimativa do risco de alagamento SE a previsão se confirmar — diferente do índice principal do bairro, que usa dado já observado, não previsto.",
  },
} as const;
